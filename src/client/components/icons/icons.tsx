 ...
 */
export const SearchIcon: FC<LineIconProps> = (props) => (
    <LineIcon {...props}>
 ...
 */
export const HomeIcon: FC<LineIconProps> = (props) => (
    <LineIcon {...props}>
 ...
 */
export const ClockIcon: FC<LineIconProps> = (props) => (
    <LineIcon {...props}>
 ...
 */
export const UsersIcon: FC<LineIconProps> = (props) => (
    <LineIcon {...props}>
